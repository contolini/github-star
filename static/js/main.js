...
var code = window.location.href.match(/\?code=(.*)/) ? window.location.href.match(/\?code=(.*)/)[1] : null,
...
function starRepos(opts) {
  ...
  var reposLeft = undefined;

  msg('Looking for repos...');

  getRepos({ token: token, org: sanitize(orgEl.value) }).then(function (repos) {
...
function init() {
  if (code) {
    showBusy(true);
    fetch('http://heart-github.herokuapp.com/authenticate/' + code).then(function (resp) {
      return resp.json();
    }).then(function (json) {
      if (json.token) {
...
},{"./getEndpoint":5,"./getRepos":6,"./msg":7,"./sanitize":8,"./starRepo":9,"whatwg-fetch":3}],5:[function(require,module,exports){
"use strict";
...
function getRepos(opts) {
  ...
  return new Promise(function (resolve, reject) {
    function getNextRepo() {
      ...
      fetch(endpoint({ org: org, currentPage: currentPage }), {
        headers: {
...
},{"./getEndpoint":5,"./msg":7,"es6-promise":1,"whatwg-fetch":3}],7:[function(require,module,exports){
'use strict';
